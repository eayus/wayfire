...
namespace wf
{
    ...
    struct output_layout_output_t
    {
        ...
        void render_output(wlr_texture *texture)
        {
            ...
            wlr_renderer_begin(get_core().renderer, handle->width, handle->height);
            ...
            wlr_render_texture_with_matrix(get_core().renderer, texture, box, 1.0);
            wlr_renderer_end(get_core().renderer);
